...
const error = { messageId: 'default', data: { name: 'data' } };
const removeError = { messageId: 'default', data: { name: 'removeData' } };
const hasError = { messageId: 'default', data: { name: 'hasData' } };
