...
const showError = { messageId: 'default', data: { method: 'show' } };
const hideError = { messageId: 'default', data: { method: 'hide' } };
const toggleError = { messageId: 'default', data: { method: 'toggle' } };
